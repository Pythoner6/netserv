    ...
    let
      ...
      flux = pkgs.stdenv.mkDerivation {
        ...
        src = utils.fetchurlHexDigest {
          url = "https://github.com/fluxcd/flux2/releases/download/v2.2.0/flux_2.2.0_linux_amd64.tar.gz"; digest = "223c3246663f9a31b6f67da7283af1fe77b4e42ddbfdc93e728829f0e976c97a";
        };
        dontUnpack = true;
      ...
      charts = cue.charts {
        ...
        external-secrets.src = utils.fetchurlHexDigest {
          ...
          url = "https://github.com/fluxcd/flux2/releases/download/v0.41.2/flux_0.41.2_linux_amd64.tar.gz"; digest = "";
        };
