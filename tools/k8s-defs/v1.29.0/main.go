...
import (
  _ "k8s.io/api/resource/v1alpha2"
  ...
  _ "k8s.io/api/networking/v1alpha1"
  ...
  _ "k8s.io/api/flowcontrol/v1beta3"
  _ "k8s.io/api/flowcontrol/v1"
  _ "k8s.io/api/authentication/v1beta1"
  _ "k8s.io/api/authentication/v1"
  _ "k8s.io/api/authentication/v1alpha1"
  ...
  _ "k8s.io/api/certificates/v1alpha1"
